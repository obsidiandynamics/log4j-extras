...
public final class SplunkHECAppender extends AppenderSkeleton {
  ...
  protected void append(LoggingEvent event) {
    try {
      if (shi == null) {
        setPropertyConditional("log4jextras.splunk.token", this::setToken);
        setPropertyConditional("log4jextras.splunk.url", this::setUrl);
        setPropertyConditional("log4jextras.splunk.index", this::setIndex);
        setPropertyConditional("log4jextras.splunk.source", this::setSource);
